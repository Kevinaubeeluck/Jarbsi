...
def run_ORB(frame1, frame2):   
    ...
    final_img = cv2.drawMatches(frame1, queryKeypoints, frame2, trainKeypoints, matches[:20],None)
...
def VO(frame1, frame2):
    ...
    P2 = get_P(pts1, pts2, K) # Extrinsic matrix of frame 2
...
frame1_raw = cv2.imread('C:/Users/User/Pictures/Saved Pictures/Calc_tilt.jpeg')
frame2_raw = cv2.imread('C:/Users/User/Pictures/Saved Pictures/Calc.jpeg')
